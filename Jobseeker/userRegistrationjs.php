...
<body bgcolor="white">
    ...
    <form name="jsForm" action="userRegistration.php" onsubmit="return validate()" method="post">
	...
	<h1 align="center" style="background-color: gray;  "><i>Registration</i></h1>
            ...
            <fieldset>
                ...
                <input class="inputField" type="text" name="uname" id="uname">
                ...
                <input class="inputField" type="password" name="pass" id="pass">
